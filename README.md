...
![Installing TypeSpan via the Glyphs Plugin Manager and restarting](images/install-restart-glyphs.gif)
...
![Enabling TypeSpan from the View menu in Glyphs.app](images/enable-typespan-view-menu.gif)
...
![TypeSpan automatically pausing and resuming tracking when switching apps](images/auto-pause-resume-tracking.gif)

## Preferences

1. Right-click anywhere in Edit view and select **TypeSpan Preferences** from the context menu

![Opening TypeSpan Preferences from the right-click context menu](images/context-menu-settings.gif)

2. For the full settings panel, go to **Window > TypeSpan Preferences**

![TypeSpan Preferences window](images/preferences-window.gif)
...
![Export TypeSpan Report dialog with data options](images/export-options-dialog.gif)
